...
//  }
  ...
  public static class Founded {
    public static AuthLoginRequest getAuthLoginRequest(CreateUserRequest createUserRequest) {
      ...
      return getAuthLoginRequest(username, password);
    }

    public static AuthLoginRequest getAuthLoginRequest(String username, String password) {
    ...
    public static AuthLoginRequest getAuthLoginRequestWithAdminCreds() {
      return AuthLoginRequest.builder()
